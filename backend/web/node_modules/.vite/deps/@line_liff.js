...
// web/node_modules/tiny-sha256/index.js
var require_tiny_sha256 = __commonJS({
  "web/node_modules/tiny-sha256/index.js"(exports, module) {
    (function(global2, factory) {
      ...
      var sha256 = function sha2562(ascii) {
        ...
        var k3 = sha2562.k = sha2562.k || [];
        var primeCounter = k3[lengthProperty];
        var isComposite = {};
        for (var candidate = 2; primeCounter < 64; candidate++) {
          if (!isComposite[candidate]) {
            ...
            k3[primeCounter++] = mathPow(candidate, 1 / 3) * maxWord | 0;
          }
        }
        ascii += "";
        ...
        for (j3 = 0; j3 < words[lengthProperty]; ) {
          ...
          for (i6 = 0; i6 < 64; i6++) {
            ...
            var temp1 = hash[7] + (rightRotate(e10, 6) ^ rightRotate(e10, 11) ^ rightRotate(e10, 25)) + (e10 & hash[5] ^ ~e10 & hash[6]) + k3[i6] + (w7[i6] = i6 < 16 ? w7[i6] : w7[i6 - 16] + (rightRotate(w15, 7) ^ rightRotate(w15, 18) ^ w15 >>> 3) + w7[i6 - 7] + (rightRotate(w22, 17) ^ rightRotate(w22, 19) ^ w22 >>> 10) | 0);
...
// web/node_modules/whatwg-fetch/fetch.js
...
// web/node_modules/tslib/tslib.es6.mjs
var extendStatics = function(d8, b8) {
  extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d9, b9) {
    d9.__proto__ = b9;
  } || function(d9, b9) {
    for (var p13 in b9) if (Object.prototype.hasOwnProperty.call(b9, p13)) d9[p13] = b9[p13];
  };
...
var __assign = function() {
  __assign = Object.assign || function __assign2(t2) {
    for (var s12, i6 = 1, n6 = arguments.length; i6 < n6; i6++) {
      s12 = arguments[i6];
...
function __values(o7) {
  var s12 = typeof Symbol === "function" && Symbol.iterator, m10 = s12 && o7[s12], i6 = 0;
...
// web/node_modules/@liff/logger/lib/index.es.js
var n;
!function(o7) {
...
// web/node_modules/@liff/use/lib/index.es.js
...
var u = function() {
  ...
  return n6.prototype.addModule = function(n7, o7) {
    this.modules.set(n7, o7), o7.hooks && (this.hooks[n7] = Object.entries(o7.hooks).reduce(function(n8, o8) {
      var i6, r10 = __read(o8, 2), s12 = r10[0], u13 = r10[1];
      return __assign(__assign({}, n8), ((i6 = {})[s12] = u13.on.bind(u13), i6));
...
var c = function(t2) {
  ...
  return __extends(e10, t2), e10.prototype.install = function() {
    ...
    return function(i6, r10) {
      ...
      var s12 = l(i6) ? i6.name : "".concat(n6).concat(i6.name);
      ...
      return this["".concat(s12)] ? (i.warn("There is a duplicate plugin name. `".concat(s12, "` plugin namespace will be override.")), this["".concat(s12)] = u13) : void 0 !== u13 && (this["".concat(s12)] = u13), t3.addModule(s12, i6), this;
    };
  }, e10;
}(a);

// web/node_modules/@liff/ready/lib/index.es.js
var e;
var n2 = new Promise(function(n6) {
  e = n6;
});

// web/node_modules/@liff/consts/lib/index.es.js
var e2 = "UNKNOWN";
var t = "UNAUTHORIZED";
...
// web/node_modules/@liff/util/lib/index.es.js
function c3(n6) {
...
// web/node_modules/@liff/is-in-client/lib/index.es.js
var c4 = null;
function u3() {
...
// web/node_modules/@liff/store/lib/index.es.js
function c5() {
  var n6;
...
// web/node_modules/@liff/is-logged-in/lib/index.es.js
function e3() {
  return !!x2();
}
var o2 = function(r10) {
...
// web/node_modules/@liff/get-version/lib/index.es.js
function r4() {
  return "2.26.1";
}
var e4 = function(n6) {
...
// web/node_modules/@liff/is-sub-window/lib/index.es.js
var a4 = function() {
  function t2() {
  }
...
// web/node_modules/@liff/get-line-version/lib/index.es.js
function r5() {
...
// web/node_modules/@liff/get-os/lib/index.es.js
var r6;
function e6() {
  if (!r6) {
...
// web/node_modules/@liff/is-api-available/lib/index.es.js
function b3(e10) {
  var r10, n6 = E3();
  return null === (r10 = null == n6 ? void 0 : n6.availability) || void 0 === r10 ? void 0 : r10[e10];
}
function v3(e10, n6, a10) {
  var i6 = b3(e10), t2 = a10 || e10;
  if (!i6) return { available: false, error: { code: E, message: "".concat(t2, " is not allowed in this LIFF app") } };
  var l13 = i6.minVer, c14 = i6.unsupportedFromVer, s12 = !l13 || function(e11, r10) {
    var n7 = r5();
    return !!n7 && !(r10 && f2(n7, r10) > 0) && f2(n7, e11) >= 0;
  }(l13, c14), d8 = u3();
  return d8 && !s12 ? { available: false, error: { code: E, message: "".concat(t2, " is unavailable in this client version.") } } : i6.permission ? d8 && s12 || n6 ? { available: true } : { available: false, error: { code: E, message: "".concat(t2, " is not allowed in external browser") } } : { available: false, error: { code: E, message: "".concat(t2, " is not allowed in this LIFF app") } };
}
var g4 = function() {
...
var h3 = ["subwindowOpen", "shareTargetPicker", "multipleLiffTransition", "scanCode", "scanCodeV2", "getAdvertisingId", "addToHomeScreen", "bluetoothLeFunction", "skipChannelVerificationScreen", "createShortcutOnHomeScreen", "internalCreateShortcutOnHomeScreen", "iap"];
var w3 = { scanCode: function() {
  return v3("scanCode");
  ...
  var a10 = v3("addToHomeV2", true, "internalCreateShortcutOnHomeScreen");
  return a10.available ? v3("addToHomeLineScheme", true, "internalCreateShortcutOnHomeScreen") : a10;
}, iap: function() {
  return u3() ? e3() ? d3() ? { available: false, error: { code: E, message: "this api can be only called in parent window" } } : v3("iap", false, "In-App Purchase") : { available: false, error: { code: t, message: "Need access_token for api call, Please login first" } } : { available: false, error: { code: E, message: "In-App Purchase is not allowed in external browser" } };
} };
var S4 = function(e10) {
  return function() {
    var r10 = e10();
...
var C4 = { scanCode: S4(w3.scanCode), getAdvertisingId: S4(w3.getAdvertisingId), bluetoothLeFunction: S4(w3.bluetoothLeFunction), shareTargetPicker: S4(w3.shareTargetPicker), multipleLiffTransition: S4(w3.multipleLiffTransition), subwindowOpen: S4(w3.subwindowOpen), scanCodeV2: S4(w3.scanCodeV2), addToHomeScreen: S4(w3.addToHomeScreen), skipChannelVerificationScreen: S4(w3.skipChannelVerificationScreen), createShortcutOnHomeScreen: S4(w3.createShortcutOnHomeScreen), internalCreateShortcutOnHomeScreen: S4(w3.internalCreateShortcutOnHomeScreen), iap: S4(w3.iap) };
function T4(e10) {
  if (!function(e11) {
...
// web/node_modules/@liff/check-availability/lib/index.es.js
var e7 = function() {
  function t2() {
  }
...
// web/node_modules/@liff/extensions/lib/es/index.js
...
// web/node_modules/@liff/logout/lib/index.es.js
function o4() {
  tn();
}
var e8 = function(r10) {
...
// web/node_modules/@liff/server-api/lib/index.es.js
function c7(a10) {
...
// web/node_modules/@liff/message-bus/lib/index.es.js
...
var p7 = function(e10, s12, r10) {
  return __awaiter(void 0, void 0, void 0, function() {
    var t2, o7, c14, d8;
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          return n6.trys.push([0, 3, , 4]), t2 = new TextEncoder().encode(e10), [4, v4(s12)];
        case 1:
    ...
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          return n6.trys.push([0, 3, , 4]), t2 = new TextEncoder().encode(e10), [4, v4(s12)];
        case 1:
          for (o7 = n6.sent(), c14 = atob(r10), d8 = new Uint8Array(c14.length), u13 = 0; u13 < c14.length; u13++) d8[u13] = c14.charCodeAt(u13);
...
var E4 = function(r10) {
  ...
  this.identification = { identifier: "", cryptoKey: "" }, this.messageHandlerInstance = null, this.listeners = /* @__PURE__ */ new Map(), this.sentMessages = [], this.generateIdentification = function() {
    return __awaiter(o7, void 0, void 0, function() {
      ...
      return __generator(this, function(l13) {
        switch (l13.label) {
          ...
          case 2:
            d8 = e10.get(c8) || r11(c8) || "", l13.label = 3;
          case 3:
    ...
    return __awaiter(o7, void 0, void 0, function() {
      var e10, t2, s12, r11, o8, c14 = this;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
          ...
          case 1:
            ...
            return (s12 = document.createElement("iframe")).style.display = "none", s12.src = "about:blank", document.body.appendChild(s12), null === (o8 = null == s12 ? void 0 : s12.contentWindow) || void 0 === o8 || o8.window.eval("(".concat(b4.toString().replace("$MESSAGE_HANDLER_URL", "".concat("https://liff-subwindow.line.me/liff/v2/sub/messageHandler")).replace("$IDENTIFIER", e10.split("'")[0]), ")()")), r11 = "iframe-".concat(e10, "-ready"), [4, new Promise(function(e11) {
              var t3 = function(n7) {
                n7.data[r11] && (c14.messageHandlerInstance = s12, window.addEventListener("message", c14.proxyToListeners), e11(), document.removeEventListener("message", t3));
              };
    ...
    return __awaiter(o7, void 0, void 0, function() {
      var t2, s12, r11, a10, o8 = this;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            if (!this.isReady()) throw w("message bus is not ready to send message");
            return s12 = { action: g5(e10.eventName), identifier: this.identification.identifier || "", timestamp: (/* @__PURE__ */ new Date()).getTime() }, [4, this.getEncryptedContext(e10)];
          case 1:
            return s12.context = n6.sent(), t2 = s12, null === (a10 = null === (r11 = this.messageHandlerInstance) || void 0 === r11 ? void 0 : r11.contentWindow) || void 0 === a10 || a10.postMessage({ messageBusEvent: t2 }, "*"), this.sentMessages.push(y4(t2)), [4, new Promise(function(e11) {
      ...
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            ...
            return r11 = { action: u6.BROADCAST }, [4, this.getEncryptedContext(s12)];
          case 1:
    ...
    return __awaiter(o7, void 0, void 0, function() {
      ...
      return __generator(this, function(a10) {
        return s12 = i6.data.messageBusEvent, "https://liff-subwindow.line.me" !== i6.origin ? [2] : s12 ? (this.sentMessages.includes(y4(s12)) || s12.identifier !== this.identification.identifier || s12.action !== u6.BROADCAST && !s12.replyTarget || this.listeners.forEach(function(i7) {
          return __awaiter(r11, void 0, void 0, function() {
            var t2, r12, a11;
            return __generator(this, function(n6) {
              switch (n6.label) {
                case 0:
                  return t2 = i7, r12 = [__assign({}, s12)], a11 = {}, [4, this.getDecryptedContext(s12.context)];
                case 1:
    ...
    return __awaiter(o7, void 0, void 0, function() {
      var t2, i6, s12, r11, a10, o8, c14;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            return t2 = this.identification, i6 = t2.identifier, s12 = t2.cryptoKey, a10 = (r11 = JSON).stringify, c14 = { eventName: e10.eventName, key: e10.key ? e10.key : void 0 }, e10.data ? [4, p7(i6, s12, JSON.stringify(e10.data))] : [3, 2];
          case 1:
    ...
    return __awaiter(o7, void 0, void 0, function() {
      var t2, s12, r11, a10, o8, c14, d8, u13;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            return t2 = this.identification, s12 = t2.identifier, r11 = t2.cryptoKey, (a10 = JSON.parse(i6)).data && "string" == typeof a10.data ? (u13 = (d8 = JSON).parse, [4, m6(s12, r11, a10.data)]) : [3, 2];
          case 1:
...
// web/node_modules/@liff/native-bridge/lib/index.es.js
function l8(e10) {
...
// web/node_modules/@liff/close-window/lib/index.es.js
function r8() {
  var o7 = r5();
...
// web/node_modules/@liff/sub-window/lib/index.es.js
function G3(t2) {
...
function dt(n6, r10) {
  return void 0 === r10 && (r10 = {}), __awaiter(this, void 0, void 0, function() {
    var t2, i6, o7, s12, u13, a10, c14, f14;
    return __generator(this, function(e10) {
      switch (e10.label) {
        case 0:
          if (null == (t2 = ut()) ? void 0 : t2.isReady()) return [3, 5];
          if (i6 = JSON.stringify(r10), o7 = c5().liffId, s12 = lt(), !window.opener || !s12 || !o7) throw w(N);
        ...
        case 4:
          return f14 = u13 ? s12 : location.origin, [2, new Promise(function(t3) {
...
function mt(t2) {
  ...
  if (t2.origin === n6) {
    var r10 = t2.data;
    if (r10) {
      var i6, o7 = r10.status, s12 = r10.result;
      try {
        i6 = JSON.parse(s12 || "{}");
      } catch (u13) {
        i6 = {};
...
function gt(i6) {
  var o7;
  return __awaiter(this, void 0, void 0, function() {
    var t2, s12, u13, a10, c14, f14, l13, b8, y6, S7, I8;
    return __generator(this, function(e10) {
      switch (e10.label) {
        case 0:
          return (t2 = k(i6.url)) ? (ht(true), [4, wt()]) : [2, Promise.reject(w(i3, "params.url must be liff url or mini url"))];
        case 1:
          return e10.sent(), nt("ios" !== e6() || P() ? window.open("", "liffsubwindow", "width=480, height=640, menubar=no, toolbar=no, scrollbars=yes") : window.open()), s12 = i6.url, u13 = i6.appData, (a10 = new URL(s12)).searchParams.append(L, "true"), [4, st()];
        case 2:
...
function yt(i6) {
  return __awaiter(this, void 0, void 0, function() {
    var o7, s12, u13, a10, c14, f14, l13, m10, v7, h6, w7, g10, y6, S7, I8 = this;
    return __generator(this, function(P6) {
      switch (P6.label) {
        case 0:
          if (o7 = i6.msit, s12 = i6.mstChallenge, u13 = i6.reconnectCount, a10 = void 0 === u13 ? 0 : u13, c14 = function() {
            return __awaiter(I8, void 0, void 0, function() {
              return __generator(this, function(t2) {
                switch (t2.label) {
                  case 0:
                  ...
                  case 1:
                    return t2.sent(), [4, yt({ msit: o7, mstChallenge: s12, onSuccess: i6.onSuccess, onError: i6.onError, reconnectCount: a10 + 1 })];
                  case 2:
                    return t2.sent(), [2];
                }
                var e10;
          ...
          P6.label = 1;
        case 1:
          return P6.trys.push([1, 3, , 5]), [4, p6(l7("subWindowSubscribe"), { method: "POST", body: JSON.stringify({ msit: o7, mstChallenge: s12 }) })];
        case 2:
...
function Pt(n6) {
  var r10 = n6.appData, i6 = n6.native, o7 = c5().liffId, s12 = M(), u13 = k(n6.url);
  ...
  }({ mainLiffId: o7, subLiffId: u13, mstChallenge: s12, appData: r10, view: It(a10) }).then(function(t2) {
    var e10 = t2.msit;
    return yt({ msit: e10, mstChallenge: s12, onSuccess: function(t3, e11) {
      F3(t3, e11);
    }, onError: function(t3) {
      F3(C.ERROR, t3);
    } }), e10;
...
// web/node_modules/@liff/login/lib/index.es.js
var import_tiny_sha256 = __toESM(require_tiny_sha256());

// web/node_modules/@liff/hooks/lib/index.es.js
var s7 = function() {
  var e10 = this;
  this.type = "sync", this.fns = /* @__PURE__ */ new Set(), this.on = function(n6) {
    e10.fns.add(n6);
  }, this.call = function() {
    for (var i6, s12, a10 = [], o7 = 0; o7 < arguments.length; o7++) a10[o7] = arguments[o7];
    try {
      ...
      try {
        c14 && !c14.done && (s12 = l13.return) && s12.call(l13);
      } finally {
...
var a6 = function() {
  ...
  this.type = "async", this.fns = /* @__PURE__ */ new Set(), this.on = function(n6) {
    ...
    return __awaiter(s12, void 0, void 0, function() {
      var e10, s13, o8, l13, c14, f14;
      return __generator(this, function(i6) {
        switch (i6.label) {
          case 0:
            e10 = [];
            try {
              for (s13 = __values(this.fns), o8 = s13.next(); !o8.done; o8 = s13.next()) l13 = o8.value, e10.push(l13.apply(void 0, __spreadArray([], __read(a10), false)));
            } catch (u13) {
              c14 = { error: u13 };
            } finally {
              try {
                o8 && !o8.done && (f14 = s13.return) && f14.call(s13);
              } finally {
...
// web/node_modules/@liff/i18n/lib/index.es.js
var a7;
...
// web/node_modules/@liff/init/lib/index.es.js
...
function Le(t2) {
  var r10 = E3(), n6 = (null == r10 ? void 0 : r10.menuColorSetting) || { adaptableColorSchemes: ["light"], lightModeColor: Te, darkModeColor: Ae }, o7 = n6.adaptableColorSchemes, i6 = n6.lightModeColor, a10 = n6.darkModeColor, c14 = o7.includes("dark");
  t2.matches && c14 ? Ne(__assign(__assign({}, Ae), a10)) : Ne(__assign(__assign({}, Te), i6));
}
function Ne(e10) {
  var t2 = e10.iconColor, r10 = e10.statusBarColor, n6 = e10.titleTextColor, o7 = e10.titleSubtextColor, i6 = e10.titleButtonColor, a10 = e10.titleBackgroundColor, c14 = e10.progressBarColor, s12 = e10.progressBackgroundColor, u13 = e10.titleButtonAreaBackgroundColor, d8 = e10.titleButtonAreaBorderColor, h6 = e10.baseBackgroundColor, p13 = e10.baseTextColor, v7 = e10.lightButtonBorderColor;
  De("--liff-base-background-color", h6), De("--liff-base-text-color", p13), De("--liff-base-background-rgb-color", d(h6)), De("--liff-base-text-rgb-color", d(p13)), De("--liff-light-button-border-color", v7), De("--liff-title-text-color", n6), De("--liff-title-background-color", a10), De("--liff-title-button-color", i6), De("--liff-icon-color", t2), De("--liff-status-bar-color", r10), De("--liff-title-subtext-color", o7), De("--liff-progress-bar-color", c14), De("--liff-progress-background-color", s12), De("--liff-title-button-area-background-color", s3(u13)), De("--liff-title-button-area-border-color", s3(d8));
}
function De(e10, t2) {
  document.documentElement.style.setProperty(e10, t2);
}
var Oe = { addToHomeScreen: function(e10) {
    ...
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
          return [4, y3()];
        case 1:
          return (t2 = r10.sent()) ? (t2.install(e10, Oe), [2]) : [2];
      }
    });
  });
}
...
function je(e10, o7) {
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6, a10, c14, s12, l13, f14, p13, v7, m10, w7, g10, b8, k3, C7, F4;
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
          return t2 = e10.split("."), i6 = __read(t2, 3), a10 = i6[0], c14 = i6[1], s12 = i6[2], l13 = JSON.parse(u2.decode(a10)), f14 = JSON.parse(u2.decodeUnicode(c14)), p13 = l3(u2.decode(s12)), v7 = l3("".concat(a10, ".").concat(c14)), [4, Ue()];
        case 1:
        ...
        case 2:
          return r10.trys.push([2, 4, , 5]), [4, We(w7, v7, p13)];
        case 3:
        ...
        case 5:
          if (g10) {
            if (k3 = f14.iss !== "https://access.".concat("line.me"), C7 = f14.aud !== o7, F4 = 1e3 * f14.exp < Date.now(), k3) throw w(T, 'Invalid "iss" value in ID_TOKEN');
...
var Ke = null;
function Re() {
  "boolean" == typeof Ke && i.warn("liff.init is not expected to be called more than once"), Ke = !!O3() || !(!u3() || A2.parse(window.location.hash).feature_token || w2()) && (P2(true), true);
}
function Ve() {
  return Boolean(Ke);
}
      ...
      switch (r10.label) {
        case 0:
          return t2 = A2.parse(window.location.hash), n6 = function(e11) {
            ...
            try {
              for (var c14 = __values(n7), s12 = c14.next(); !s12.done; s12 = c14.next()) {
                a11(s12.value);
              }
            } catch (l13) {
              t3 = { error: l13 };
              ...
              try {
                s12 && !s12.done && (r11 = c14.return) && r11.call(c14);
              } finally {
...
function Ge(e10) {
  if (e10.persisted && T4("multipleLiffTransition")) if ("ios" === e6()) window.location.reload();
    ...
    He({ pathname: "app/".concat(t2), query: { feature_token: r10 } });
  }
}
function Qe(e10) {
  var n6, o7;
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6, a10, c14, l13, f14, d8, h6, v7, g10, b8, C7, F4, y6, I8, _5, B3;
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
        ...
        case 2:
          ...
          return !d3() && c14 && (!function(e11, t3) {
            T4("multipleLiffTransition") && He({ pathname: "app/".concat(e11), query: { feature_token: t3 } });
        ...
        case 6:
          if (b8 = r10.sent(), C7 = b8.client_id, F4 = b8.expires_in, y6 = m2(e10.liffId), C7 !== y6) throw _3(), w(I, "Failed to verify access_token");
          U3(c14), q(new Date(Date.now() + 1e3 * F4)), B2(i6), r10.label = 7;
        case 7:
          return [4, Je(v7, d8)];
        case 8:
          return (I8 = r10.sent()) ? (L3(I8), [4, Dt({ mst: I8 })]) : [3, 10];
        case 9:
    ...
    return __generator(this, function(r10) {
      switch (r10.label) {
        ...
        case 1:
          ...
          if (!(s12 = Me(c14))) throw w(I, "Invalid context token.");
          return [2, s12];
      }
    });
  });
          ...
          n6 = function() {
            return __awaiter(a10, void 0, void 0, function() {
              ...
              return __generator(this, function(r10) {
                switch (r10.label) {
                  case 0:
                    return [4, (s12 = c5(), l13 = A2.parse(window.location.search), f14 = J2(), u13 = { grant_type: "authorization_code", client_id: l13.liffClientId, appId: s12.liffId, code: l13.code, code_verifier: f14.codeVerifier, redirect_uri: s12.redirectUri || l13.liffRedirectUri, id_token_key_type: "JWK" }, d8 = A2.stringify(u13), f5(l7("token"), { method: "POST", headers: { "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8" }, body: d8 }))];
                  case 1:
                  ...
                  case 3:
                    return (c15 = A2.parse(location.hash).context_token) ? (I3(Me(c15)), [3, 6]) : [3, 4];
                  case 4:
                    return [4, Ye()];
                  case 5:
...
var et2 = new (function() {
  function e10() {
    ...
    this.getAndValidateContext = function() {
      ...
      t2 = t2.replace(/\n/g, "%0D%0A");
      var n6 = e11.hasTrailingSlash(r10.endpointUrl) || e11.hasTrailingSlash(t2), o7 = new URL(r10.endpointUrl), i6 = o7.origin, a10 = o7.pathname, c14 = o7.search, s12 = new URL("".concat(i6).concat(e11.attachSlashAtStart(t2))), l13 = s12.pathname, f14 = s12.search, u13 = s12.hash, d8 = "".concat(c14).concat(c14 ? f14.replace(/\?/g, "&") : f14), h6 = "".concat(a10).concat(e11.attachSlashAtStart(l13)).replace("//", "/");
  ...
  }, e10.prototype.hasTrailingSlash = function(e11) {
    var t2 = e11.indexOf("?"), r10 = e11.indexOf("#"), n6 = -1;
    return (n6 = -1 === t2 && -1 === r10 ? e11.length : -1 === t2 ? r10 : -1 === r10 ? t2 : Math.min(t2, r10)) > 0 && "/" === e11[n6 - 1];
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(r10) {
        switch (r10.label) {
          ...
          case 2:
            return r10.trys.push([2, 9, , 11]), [4, Promise.all([Pe(this.liffForWindow), tt2(e11, this.internalHooks.beforeFinished.call)])];
          case 3:
...
// web/node_modules/@liff/get-language/lib/index.es.js
function r9() {
...
// web/node_modules/@liff/get-app-language/lib/index.es.js
function f9() {
  var r10 = r5();
...
// web/node_modules/@liff/permission/lib/index.es.js
function I4(r10) {
  return __awaiter(this, void 0, void 0, function() {
    var e10, i6, o7, u13, l13, h6, v7;
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
          return function(e11) {
            if (!U.includes(e11)) throw w(i3, "Unexpected permission name.");
            var t3 = E3();
            return !!(null == t3 ? void 0 : t3.scope.includes(e11));
          }(r10) ? (e10 = x2()) ? [4, d4(e10)] : [3, 2] : [2, { state: "unavailable" }];
        case 1:
          i6 = t2.sent(), o7 = unescape(i6.scope).split(" ");
          try {
            for (u13 = __values(o7), l13 = u13.next(); !l13.done; l13 = u13.next()) if (l13.value.includes(r10)) return [2, { state: "granted" }];
          } catch (m10) {
            h6 = { error: m10 };
          } finally {
            try {
              l13 && !l13.done && (v7 = u13.return) && v7.call(u13);
            } finally {
...
function S5() {
  var e10 = c5().liffId;
  if (e10) return f5("".concat(l7("unauthorizedPermissions"), "?liffId=").concat(e10), { headers: { "Content-Type": "application/json", Accept: "application/json", Authorization: "Bearer ".concat(x2()) } });
...
var x3 = function() {
  ...
  return n6.prototype.setup = function() {
    P3("submit", this.onSubmit), P3("close", this.onClose), P3("cancel", this.onCancel), P3("error", this.onError);
  }, n6.prototype.teardown = function() {
    q3("submit", this.onSubmit), q3("close", this.onClose), q3("cancel", this.onCancel), q3("error", this.onError), T5 = void 0;
  }, n6.prototype.open = function(e10) {
    var t2 = c5().liffId;
    t2 ? _4({ url: "".concat("https://liff.line.me/1656032314-Xgrw5Pmk"), appData: { liffId: t2, channelId: m2(t2), accessToken: x2() }, onBeforeTransition: e10 }).catch(this.reject) : this.reject(w(t, "liffId is required"));
  }, n6;
}();
function E5() {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(o7) {
      switch (o7.label) {
        case 0:
          ...
          return T5 && T5.teardown(), n6 = function() {
            return __awaiter(i6, void 0, void 0, function() {
              var e10;
              return __generator(this, function(t2) {
                switch (t2.label) {
                  case 0:
                    return [4, S5()];
                  case 1:
                    if (e10 = t2.sent(), (u3() ? e10 : e10.filter(function(e11) {
          ...
          }, [4, new Promise(function(e10, t2) {
            (T5 = new x3(e10, t2)).open(n6);
          })];
        case 1:
  ...
  return function() {
    ...
    return __awaiter(s12, void 0, void 0, function() {
      ...
      return __generator(this, function(t2) {
        switch (t2.label) {
          case 0:
            return e10 = (c14.length > 0 ? c14[c14.length - 1] : {}).ignorePermissionCheck, s13 = void 0 !== e10 && e10, [4, I4(o7)];
          case 1:
            if ("unavailable" !== (a11 = t2.sent().state)) return [3, 2];
            throw w(E, "The permission is not in LIFF app scope.");
          case 2:
            return "prompt" !== a11 || !A4() || s13 || !u3() && "chat_message.write" === o7 ? [3, 4] : [4, E5()];
          case 3:
            return t2.sent(), [3, 5];
          case 4:
            s13 && c14.pop(), t2.label = 5;
          case 5:
            return [4, n6.apply(void 0, __spreadArray([], __read(c14), false))];
          case 6:
            return [2, t2.sent()];
        }
      });
...
var V3 = function(e10) {
  ...
  return __extends(t2, e10), Object.defineProperty(t2.prototype, "name", { get: function() {
    ...
    return { query: I4, requestAll: E5 };
  }, t2;
}(a);
var z3 = new V3();

// web/node_modules/@liff/get-profile/lib/index.es.js
function n4() {
...
// web/node_modules/@liff/open-window/lib/index.es.js
...
function p10(n6) {
  ...
  if (u3()) if (null !== u13 && "ios" === e6() && f2(u13, "9.19") >= 0 || !window._liff.postMessage) {
    var p13 = n6.url, s12 = n6.external, d8 = void 0 !== s12 && s12;
    window.open(function(n7, t2) {
      var o7, e10, r10, f14, l13, c14, u14, p14, s13;
      (function(n8) {
        return -1 !== n8.indexOf("#") && -1 !== n8.indexOf("?") && n8.indexOf("#") < n8.indexOf("?");
      })(n7) || function(n8) {
        return -1 === n8.indexOf("?") && -1 !== n8.indexOf("#");
      }(n7) ? (u14 = (o7 = __read(n7.split("#"), 2))[0], e10 = o7[1], p14 = (r10 = __read((void 0 === e10 ? "" : e10).split("?"), 2))[0], s13 = r10[1]) : (u14 = (f14 = __read(n7.split("?"), 2))[0], l13 = f14[1], s13 = (c14 = __read((void 0 === l13 ? "" : l13).split("#"), 2))[0], p14 = c14[1]);
      var d9 = a8(s13, p14);
...
// web/node_modules/@liff/send-messages/lib/index.es.js
var m7 = function(r10) {
...
// web/node_modules/@liff/get-friendship/lib/index.es.js
function o6() {
...
// web/node_modules/@liff/analytics/lib/index.es.js
function g7() {
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6;
    return __generator(this, function(e10) {
...
var I5 = function(u13) {
  ...
  return __extends(d8, u13), Object.defineProperty(d8, "CUSTOMPLACEID_INIT", { get: function() {
    ...
    var t2, e10 = this.utsExtra, i6 = e10.isLiffSuccessful, s12 = e10.isLoggedIn, r10 = e10.id, n6 = e10.version, o7 = (s12 ? d8.LiffUtsLoginStatus.isLoggedIn : 0) | (i6 ? d8.LiffUtsLoginStatus.isLiffSuccessful : 0);
    ...
    Object.keys(t2).forEach(function(i6) {
      if (A.includes(i6)) {
        var s12 = t2[i6];
        "string" == typeof s12 && s12 && (e10[i6.replace(/^liff\.ref\./, "")] = s12);
      }
    }), Object.keys(e10).length > 0 && (this.referrer = e10);
  }, d8.prototype.beforeInitFinished = function() {
    return __awaiter(this, void 0, void 0, function() {
      var t2, i6, r10, u14, d9, h6, g10, I8, m10, L6, S7, v7;
      return __generator(this, function(e10) {
        switch (e10.label) {
          case 0:
          ...
          case 1:
            return e10.trys.push([1, 3, , 4]), g10 = this, [4, new Promise(function(t3, e11) {
              var i7 = window.uts, s12 = document.createElement("script");
              s12.type = "text/javascript", s12.src = "https://static.line-scdn.net/uts/edge/4.1.0/uts.js", s12.onload = function() {
                var e12 = window.uts;
                t3(e12), window.uts = i7;
              }, s12.onerror = function(t4) {
                e11(t4);
          ...
          case 3:
            return I8 = e10.sent(), i.debug("[LIFFUTS] cannot load UTS, reason: ".concat(I8)), [2];
          case 4:
...
// web/node_modules/@liff/permanent-link/lib/index.es.js
...
var y5 = function(e10, i6) {
  var a10 = function(r10, e11) {
    ...
    try {
      for (var u13 = __values(o7.entries()), s12 = u13.next(); !s12.done; s12 = u13.next()) {
        var f14 = __read(s12.value, 2), l13 = f14[0], h6 = f14[1];
      ...
      try {
        s12 && !s12.done && (i7 = u13.return) && i7.call(u13);
      } finally {
...
var P4 = function(n6) {
  function t2() {
    ...
    return t3.extraParams = "", t3.getAndValidateContext = function() {
      ...
      var p13 = new RegExp("^".concat(D.join("|"))), d8 = a10.substring(1).split("&").filter(function(n8) {
        return !p13.test(n8) && Boolean(n8);
      }).join("&"), g10 = d8 === u13.hash.substring(1) ? "" : d8, v7 = function(n8) {
...
// web/node_modules/@liff/scan-code-v2/lib/index.es.js
var s9;
var u11 = function() {
  function o7(o8, t2) {
    var n6 = this;
...
// web/node_modules/@liff/window-postmessage/lib/index.es.js
var n5 = {};
function i5() {
  return n5;
}
function s10(e10, r10) {
  var o7 = i5(), n6 = __read(r10.split("."), 1)[0], s12 = o7[r10];
  s12 && e10.removeEventListener(n6, s12), o7[r10] = null;
}
var f13 = false;
var a9 = false;
...
function u12(t2, o7, n6, i6) {
  ...
  var s12 = { name: o7, body: n6 };
  t2.postMessage(s12, i6);
}
...
// web/node_modules/@liff/share-target-picker/lib/index.es.js
var I6 = function() {
  function i6() {
      ...
      return void 0 === l14 && (l14 = {}), __awaiter(i6, void 0, void 0, function() {
        ...
        return __generator(this, function(e10) {
          switch (e10.label) {
            ...
            case 1:
              return e10.trys.push([1, 3, , 4]), c14 = I6.getInstance(), b8 = r5(), y6 = { waitForSubwindowResult: true }, u3() && b8 && f2(b8, "10.11.0") < 0 && (y6.waitForSubwindowResult = false), [4, c14.init({ messages: r11, isMultiple: h6, referrer: { liffId: t2, url: location.origin }, options: y6 })];
            case 2:
              return [2, e10.sent()];
            case 3:
...
// web/node_modules/@liff/create-shortcut-on-home-screen/lib/index.es.js
function S6(n6, e10) {
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6;
    return __generator(this, function(r10) {
...
function O4(n6, e10) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
          return t2 = { liffId: n6, targetUrl: e10.url, description: e10.description }, i6 = "".concat("line://shortcut/liff", "?").concat(A2.stringify(t2)), location.href = i6, [4, I7(n6, e10)];
        case 1:
          return r10.sent(), [2];
      }
    });
...
// web/node_modules/@liff/iap/lib/index.es.js
function d7(e10) {
  var n6 = e10.productIds;
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
          return [4, w5("iap.getPlatformProducts", { productIds: n6 }).catch(function(t3) {
            if (t3.code && t3.description) throw w(t3.code, t3.description);
            throw w(e2, "Failed to get platform products", { cause: t3 });
          })];
        case 1:
          return [2, t2.sent().products];
      }
    });
  });
}
var s11 = function(e10) {
  var n6 = e10.productId, o7 = e10.orderId;
  return __awaiter(void 0, void 0, void 0, function() {
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
          return [4, w5("iap.createPayment", { productId: n6, orderId: o7 }).catch(function(t3) {
            if (t3.code && t3.description) throw w(t3.code, t3.description);
            throw w(e2, "Failed to get platform products", { cause: t3 });
          })];
        case 1:
...
var p12 = function(i6) {
  ...
  return __extends(p13, i6), Object.defineProperty(p13.prototype, "name", { get: function() {
    return "iap";
  }, enumerable: false, configurable: true }), p13.prototype.install = function() {
    var e10 = this;
    return { getPlatformProducts: function() {
      for (var i7 = [], u13 = 0; u13 < arguments.length; u13++) i7[u13] = arguments[u13];
      return __awaiter(e10, void 0, void 0, function() {
        return __generator(this, function(t2) {
          return C4.iap(), [2, d7.apply(void 0, __spreadArray([], __read(i7), false))];
        });
      });
      ...
      return __awaiter(e10, void 0, void 0, function() {
        return __generator(this, function(t2) {
          return C4.iap(), [2, s11.apply(void 0, __spreadArray([], __read(i7), false))];
        });
      });
    }, requestConsentAgreement: function() {
      return __awaiter(e10, void 0, void 0, function() {
        return __generator(this, function(e11) {
          return C4.iap(), [2, __awaiter(void 0, void 0, void 0, function() {
            return __generator(this, function(t2) {
              switch (t2.label) {
                case 0:
...
// web/node_modules/@line/liff/index.mjs
var liffInstance = {};
